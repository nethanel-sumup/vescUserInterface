...
{
private:
	static constexpr const float kMaxLevel = 42.0; // Maximum battery voltage (assuming a 10s battery)
	static constexpr const float kMinLevel = 36.0; // Minimum battery voltage (assuming a 10s battery)
